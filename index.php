...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">TechnologyShop.com</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto mb-2 mb-lg-2">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" Sid="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Products
        </a>
...
<div class="col-md-5"> </div>
  ...
  <footer class="page-footer font-smallblack  bg-dark">
